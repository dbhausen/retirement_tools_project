			...
			<Grid>
				<Typography component='div' gutterBottom>
					<ul>
						...
						<li>
							<strong>COLA Adjusted Payment:</strong> The nominal amount
							paid in this year including the Cost-Of-Living Adjustment
						</li>
						<li>
							<strong>Discounted Value:</strong> The payment discounted
							for the time value of money based the Risk-Free Rate Of
							Return
						</li>
						<li>
							<strong>Actuarial Value:</strong> The discounted value of
							the annuity payment that may or may not be received at a
							future date.
						</li>
					</ul>
				</Typography>
				...
				<Typography component='div' gutterBottom>
					...
					<ul>
						...
						<li>
							...
							of {displayCurrency(Number(annuityConfig.annuityAmount))}{' '}
							with a {annuityConfig.costOfLivingAdjustment}
							{'% '} annual Cost-Of-Living Adjustment.
						</li>
						<li>
							<strong>Discounted Value:</strong>{' '}
							<strong>{discountedAmt}</strong> is the value today of the{' '}
							{payment} that will be received in {year} based on
						...
						<li>
							...
							discounted payment multiplied by {either} (the odds that at
							least one of you will be alive to collect the payment in{' '}
							{year} based on the Social Security Life Table)
						</li>
					</ul>
				</Typography>
			</Grid>
